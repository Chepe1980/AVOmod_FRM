...
if uploaded_file is not None:
    ...
    # Crossplots - using depth filtered data
    st.header("Crossplots")
    fig2, ax2 = plt.subplots(nrows=1, ncols=4, figsize=(16, 4))
    
    # Original data crossplot
    ax2[0].scatter(ll.IP, ll.VPVS, 20, ll.LFC_B, marker='o', edgecolors='none', 
                  alpha=0.5, cmap=cmap_facies, vmin=0, vmax=4)
    ax2[0].set_xlim(3000,16000); ax2[0].set_ylim(1.5,3)
    ax2[0].set_title('Original Data')
    
    # Brine FRM crossplot
    ax2[1].scatter(ll.IP_FRMB, ll.VPVS_FRMB, 20, ll.LFC_B, marker='o', 
                  edgecolors='none', alpha=0.5, cmap=cmap_facies, vmin=0, vmax=4)
    ax2[1].set_xlim(3000,16000); ax2[1].set_ylim(1.5,3)
    ax2[1].set_title('FRM to Brine')
    
    # Oil FRM crossplot
    ax2[2].scatter(ll.IP_FRMO, ll.VPVS_FRMO, 20, ll.LFC_O, marker='o', 
                  edgecolors='none', alpha=0.5, cmap=cmap_facies, vmin=0, vmax=4)
    ax2[2].set_xlim(3000,16000); ax2[2].set_ylim(1.5,3)
    ax2[2].set_title('FRM to Oil')
    
    # Gas FRM crossplot
    ax2[3].scatter(ll.IP_FRMG, ll.VPVS_FRMG, 20, ll.LFC_G, marker='o', 
                  edgecolors='none', alpha=0.5, cmap=cmap_facies, vmin=0, vmax=4)
    ...
    # Calculate reflection coefficients function
